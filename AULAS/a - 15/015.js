...
numeros.push(1) // adicionando um elemento e seu valor automaticamente no final do array
numeros.sort() // sort organiza os valores em ordem crescente


console.log(`O array é: ${numeros}`)
console.log(`O array tem ${numeros.length} posições/elementos`) // length é o cumprimento do array



var posicoes = numeros.indexOf(1) // indexOf usado pra achar o indicie de um valor
